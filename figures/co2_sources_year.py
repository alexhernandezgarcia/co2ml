"""
This script plots the CO₂eq emitted [kg] by each model in the data set, disaggregating
...
if __name__ == "__main__":
    ...
    # Store args
    output_yml = output_dir / "co2_sources_year.yml"
    ...
    # Save figure
    output_fig = output_dir / "co2_sources_year.png"
