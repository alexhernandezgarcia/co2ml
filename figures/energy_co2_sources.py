...
def parsed_args():
    ...
    parser.add_argument(
        "--plot_carbonintensity",
        default=False,
        action="store_true",
        help="Plot Carbon intensity as the size of the dots",
    )
...
def plot_data(df, args):
    ...
    if args.plot_carbonintensity:
        sns.scatterplot(
            ...
            hue_order=hue_order,
            size="Carbon intensity [g CO₂eq/kWh]",
            sizes=(20, 200),
            alpha=0.75,
            palette=palette,
        )
...
if __name__ == "__main__":
    ...
    # Store args
    output_yml = output_dir / "energy_co2_sources.yml"
    ...
    # Save figure
    output_fig = output_dir / "energy_co2_sources.png"
