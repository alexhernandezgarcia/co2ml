"""
This script plots the number of models per energy source and throughout the years.
"""
import os
...
def plot_data(df, estimator, args):
    ...
    ax.legend(handles=leg_handles, labels=leg_labels, loc="upper left")
    if args.logaxis:
        ax.set_yscale("log")
...
if __name__ == "__main__":
    ...
    # Store args
    output_yml = output_dir / "sources_count_year.yml"
    ...
    # Save figure
    output_fig = output_dir / "sources_count_year.png"
